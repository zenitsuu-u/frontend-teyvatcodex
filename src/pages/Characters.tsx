    ...
    useEffect(() => {
        async function loadCharacters() {
            try {
                ...
                const mapped: Character[] = data.map(
                    (c: any) => ({
                        id: c.id,
                        name: c.name,
                        slug: c.slug,
                        element: c.element,
                        stars: Number(c.rarity),
                        icon: c.icon,
                    })
                );
                    ...
                    (c, index) => (
                        <div
                            ...
                            style={{
                                ...
                                boxShadow: `0 0 12px ${getElementColor(
                                    c.element
                                )}`,
